        ...
        while(pilihan != 5){
            ...
            switch (pilihan) {
                ...
                case 2:
                    if (pengirimanList.isEmpty()) {
                        ...
                        for (Pengiriman pengiriman : pengirimanList) {
                            System.out.println("No. Resi    :" + pengiriman.resi);
                            System.out.println("Nama Barang :" + pengiriman.namaBarang);
                            System.out.println("Berat       :" + pengiriman.beratBarang);
                ...
                case 3:
                    ...
                    found = false;
                    for (Pengiriman pengiriman : pengirimanList) {
                        if (pengiriman.resi.equals(resi)) {
                            System.out.println("Data Pengiriman yang akan diubah: " + pengiriman.resi);
                            System.out.print("Masukkan Nama Barang: ");
                            pengiriman.namaBarang = scanner.nextLine();
                            System.out.print("Masukkan Berat Barang: ");
                            pengiriman.beratBarang = scanner.nextFloat();
                            System.out.print("Masukkan Biaya Pengiriman: ");
                            pengiriman.biayaPengiriman = scanner.nextInt();
